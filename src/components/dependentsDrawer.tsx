...
import { addDependent } from "../helper/apiClients";
import { getEmployeeId } from "../helper/stateManagment";

function DependentsDrawer({
  displayDrawer,
  setDisplayDrawer,
  fetchData,
  notify,
  ...
  return (
    <div className="absolute right-0 top-0 h-full border-l border-grey-300">
